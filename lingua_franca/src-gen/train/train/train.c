...
void _lf_create_environments() {
    environment_init(&envs[train_main],train_main,_lf_number_of_workers,4,7,0,0,24,1,0,NULL);
}
...
void _lf_initialize_trigger_objects() {
    ...
    }
    {
        ...
        train_robot_self[0]->_lf__t.period = SEC(10);
        // Associate timer with the environment of its parent
    ...
    // Add port train.line.trigger to array of is_present fields.
    {
        ...
        {
            {
                envs[train_main].is_present_fields[20 + count] = &train_main_self[0]->_lf_line.trigger.is_present;
                #ifdef FEDERATED_DECENTRALIZED
                envs[train_main]._lf_intended_tag_fields[20 + count] = &train_main_self[0]->_lf_line.trigger.intended_tag;
                #endif // FEDERATED_DECENTRALIZED
                count++;
            }
        }
    ...
    // Add port train.robot.side_detect to array of is_present fields.
    {
        ...
        {
            {
                envs[train_main].is_present_fields[21 + count] = &train_main_self[0]->_lf_robot.side_detect.is_present;
                #ifdef FEDERATED_DECENTRALIZED
                envs[train_main]._lf_intended_tag_fields[21 + count] = &train_main_self[0]->_lf_robot.side_detect.intended_tag;
                #endif // FEDERATED_DECENTRALIZED
                count++;
            }
        }
    }
    {
        int count = 0; SUPPRESS_UNUSED_WARNING(count);
        {
            ...
            envs[train_main].is_present_fields[22 + count] = &train_line_self[0]->_lf_reflect.is_present;
            #ifdef FEDERATED_DECENTRALIZED
            // Add port train.line.reflect to array of intended_tag fields.
            envs[train_main]._lf_intended_tag_fields[22 + count] = &train_line_self[0]->_lf_reflect.intended_tag;
            #endif // FEDERATED_DECENTRALIZED
            count++;
        }
    }
    {
        int count = 0; SUPPRESS_UNUSED_WARNING(count);
        {
            ...
            envs[train_main].is_present_fields[23 + count] = &train_robot_self[0]->_lf_speed.is_present;
            #ifdef FEDERATED_DECENTRALIZED
            // Add port train.robot.speed to array of intended_tag fields.
            envs[train_main]._lf_intended_tag_fields[23 + count] = &train_robot_self[0]->_lf_speed.intended_tag;
            #endif // FEDERATED_DECENTRALIZED
            count++;
        }
    }
